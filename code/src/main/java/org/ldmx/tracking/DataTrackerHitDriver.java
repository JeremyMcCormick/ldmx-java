...
import org.hps.recon.tracking.NearestNeighborRMSClusterer;
import org.hps.recon.tracking.StripMaker;
...
public class DataTrackerHitDriver extends Driver {
    ...
    public void process(EventHeader event) {
        ...
        for (SiSensor sensor : sensors) {
            //if (debug) {
            //    System.out.println("[ DataTrackerHitDriver ]: Processing sensor: " + sensor.toString());
            //}
